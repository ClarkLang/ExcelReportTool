...
public class ReportResultGeneratorUtils {
	...
	public void versionOneScheduleDataParser(ResultBean[] versionOneReportResult) throws Exception
	{
        ...
        WritableSheet sheet = book.createSheet("B1705", 0);
        ...
        sheet = renderOneOfUserTaskInExcel(versionOneReportResult[0], sheet);
	...
	private WritableSheet renderOneOfUserTaskInExcel(ResultBean versionOneReportResult, WritableSheet sheet) throws Exception
	{
        WritableCellFormat greyBackground = new WritableCellFormat();
        ColourBean colour = new ColourBean();
        greyBackground.setBackground(colour.getTaskColour());
        
        jxl.write.Number number = new jxl.write.Number(3, 3, 40, greyBackground);
        sheet.addCell(number);
        
        sheet.mergeCells(3, 3, 3, 0); 
